"""
Super Koch HTML Scraper.

Super Koch uses the Osuper platform with GraphQL API that requires authentication.
...
class SuperKochHTMLScraper(BaseScraper):
    """
    HTML-based scraper for Super Koch (Osuper platform).
    ...
    def discover_products(self, limit: Optional[int] = None) -> List[str]:
        ...
        Returns:
            List of product URLs (e.g., ["https://www.superkoch.com.br/produtos/7804972/...", ...])
        """
    ...
    def scrape_region(self, region_key: str, product_urls: List[str]):
        ...
        Note: Super Koch doesn't have traditional region-based pricing like VTEX stores.
    ...
    def _normalize_product(
        ...
        Returns:
            Normalized product dict compatible with SuperKochProduct schema
        """
        # Extract offer data
